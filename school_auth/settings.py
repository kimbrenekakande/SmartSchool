"""
Django settings for school_auth project.
...
SECRET_KEY = 'django-insecure-s-b*lmt%_cz^a@_zud05e5zbt_8^_m-qg2y$nnk=o2ln!hg#cc'
...
# Configure installed apps without geodjango
INSTALLED_APPS = [
...
# Configure database without spatial support
DATABASES = {
    'default': {
...
# INSTALLED_APPS is now conditionally set above based on GDAL availability
...
AUTH_USER_MODEL = 'core.User'  # Make sure this points to your custom user model
